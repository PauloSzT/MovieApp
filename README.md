...
![image](app/src/main/res/drawable/favorites_screen.jpg)
...
1. Clone the repo
   ...
   git clone https://github.com/PauloSzT/MovieApp
...
Feel free to check the [issues page](https://github.com/PauloSzT/MovieApp/issues).
